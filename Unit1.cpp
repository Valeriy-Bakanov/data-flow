...
//                   __FUNC__, mI->Row-1, Really_Select, str);
                     ((char*)__FUNC__)+5, mI->Row-1, Really_Select, str); // избавляемся от TF1::
 }
 else // строка пустая
 {
...
//                   __FUNC__, Col-1, mI->Row-1, i_save);
                   ((char*)__FUNC__)+5, Col-1, mI->Row-1, i_save); // избавляемся от TF1::
...
//                   __FUNC__, Col-1, mI->Row-1);
                   ((char*)__FUNC__)+5, Col-1, mI->Row-1); // избавляемся от TF1::
//
