...
if( MI_FOP1(i) && MI_FOP2(i) ) /* флаги готовности у 1-го и 2-го операндов */ \
 add_Buffer( i, Rule ); /* добавить ГКВ-команду в буфер команд для исполнения */
//
...
if( MI_FOP1(i) && MI_FOP2(i) && /* по флагам готовности 1-й и 2-й операнды ГОТОВЫ */ \
 ...
 add_Buffer( i, Rule ); /* добавить ГКВ-инструкцию в буфер команд для исполнения */
//
...
//
////////////////////////////////////////////////////////////////////////////////
 add_Data( i_Set, aResult, Result ); // добавим в Mem_Data[] и для визуализации
////////////////////////////////////////////////////////////////////////////////
//
...
// // при СПЕКУЛЯТИВНОМ выполнении добавлять информацмю в пул данных не нужно !
 ...
 {
  add_Data( i_Set, Mem_Proc[i_Proc].aResult, Result ); // добавить результат выполнившейся инструкции
//
