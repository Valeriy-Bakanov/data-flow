...
//
   turnOn_fSpecExec_1( i ) /* установить бит режима спекулятивного выполнения (1 операнд)  */ \
//
...
//
   turnOn_fP_TRUE( i ) // включить бит для индикации цветом истинности флага-ПРЕДИКАТА
//
   turnOn_fSpecExec_2( i ) /* установить бит режима спекулятивного выполнения (2 операнда)  */ \
//
...
//
   do_Ops_2( i, Rule ) // обработка 2-х операндов (из 2-х в инструкции)
//
// завИсимая инструкция суть ПРЕДИКАТНЫй и для него не надо проверять ФЛАГ ПРЕДИКАТА
...
////////////////////////////////////////////////////////////////////////////////
 if( !( SpeculateExec && Mem_Instruction[i_Set].fSpeculateExec ) ) // при СПЕКУЛЯТИВНОМ выполнении добавлять в пул данных не нужно !
...
//
   if( MI_fOp1(i) && MI_fOp2(i) && // по флагам готовности 1-й и 2-й операнды ГОТОВЫ
     ( ( !SpeculateExec && flagPredicat_TRUE ) || // стандартное выполнение
          SpeculateExec ) ) // спекулятивное выполнение
     Add_toBuffer( i, Rule ); // добавить ГКВ-инструкцию в буфер rjvfyl lkz dsgjkytybz
//
