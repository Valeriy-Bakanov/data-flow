...
bool   __fastcall make1D_psMass( char str[], INT i ); // находит и обрабатывает (расширяет) макросы в 1D-псевдомассивы
bool   __fastcall make2D_psMass( char str[], INT i ); // ...2D-псевдомассивы
...
//
// make1D_psMass, make2D_psMass - обработчик ("расширитель") макроса в 1D- и 2D-псевдомассивы
...
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
   if( !make1D_psMass( str, i ) ) // расширение макроса в 1D-псевдомассив
//   make2D_psMass( str, i ); // ...в 2D-псевдомассив
...
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
bool __fastcall make2D_psMass( char str[], INT i )
